...
app.get("/api/download-source", authenticateToken, async (req, res) => {
  try {
...
async function startServer() {
  ...
  try {
    ...
    const isRunningCompiled = process.argv[1] && (process.argv[1].endsWith("app.js") || process.argv[1].endsWith("app.cjs") || process.argv[1].endsWith("index.js") || process.argv[1].includes("node_modules"));
